% Model
% 
% converted from quarto-docs/tutorial-fmri-spm/model.qmd
...
% ## Specify the model
% 
% Instead of the approach of the paper to use a single design matrix across all
% sessions, we here follow the standard approach of SPM, and use session-wise
% design matrices. Each of them contains eight HRF-convoluted regressors
% corresponding to the stimulus presentations of the eight conditions, six
% motion regressors derived from the realignment parameters, and a constant
% regressor.
...
% Our analyses only need the updates to the `SPM.mat` file made during
% estimation, not the parameter estimates themselves. We therefore delete the
% created `beta_####.nii` files.
